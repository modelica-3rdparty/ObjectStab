...
"));
    ...
    model TCULContinuous "Continuous approximation of TCUL control system" 
      ...
      Modelica.Blocks.Continuous.LimIntegrator integrator(
        ...
        outMin=1 + mintap*stepsize) annotation (extent=[-20,-20; 20,20]);
      annotation (
        Coordsys(
          extent=[-100, -100; 100, 100],
          grid=[2, 2],
...
"),     Diagram(
    ...
    equation 
      connect(integrator.y, y) annotation (points=[20,0; 110,0]);
      if (method == 2) then
...
"),     Diagram);
      ...
      ObsoletePetriNets.PetriNets.Place12 countup annotation (extent=[-60, -20;
              -40, 0], rotation=270);
      ObsoletePetriNets.PetriNets.Transition Tr3(condLabel="Timer>Td") 
        annotation (extent=[-80, -60; -60, -40], rotation=270);
      ObsoletePetriNets.PetriNets.Place11 actionup annotation (extent=[-80, -86;
              -60, -66], rotation=270);
      ...
      ObsoletePetriNets.PetriNets.Place12 countdown annotation (extent=[40, -20;
              60, 0], rotation=270);
      ...
      ObsoletePetriNets.PetriNets.Place11 actiondown annotation (extent=[60, -
            84; 80, -64], rotation=270);
      ObsoletePetriNets.PetriNets.Place21 updatetap annotation (extent=[-10, -
            20; 10, 0], rotation=90);
      ObsoletePetriNets.PetriNets.Transition Tr5(condLabel="") annotation (
...
"));
  ...
  equation 
    ...
    connect(Controller.y, Tr.inPort)
      annotation (points=[21,-50; 40,-50; 40,-16]);
    connect(PrimaryVoltage.T, Imp.T1) annotation (points=[-60, -20; -60, 0]);
    connect(Controller.u2, PrimaryVoltage.outPort)
      annotation (points=[-2,-56; -60,-56; -60,-30], style(color=3));
    connect(SecondaryVoltage.outPort, Controller.u1) annotation (points=[80,-10; 
          80,-30; -20,-30; -20,-44; -2,-44], style(color=3));
  end TCULCon;
...
"));
  ...
  equation 
    ...
    connect(Controller.u2, PrimaryVoltage.outPort)
      annotation (points=[-2,-56; -60,-56; -60,-30], style(color=3));
    connect(Controller.y, Tr.inPort)
      annotation (points=[22,-50; 40,-50; 40,-18], style(color=3));
    connect(SecondaryVoltage.outPort, Controller.u1) annotation (points=[80,-10; 
          80,-32; -20,-32; -20,-44; -2,-44], style(color=3));
  end TCULDis;
  annotation (
    Coordsys(
      extent=[0, 0; 393, 297],
