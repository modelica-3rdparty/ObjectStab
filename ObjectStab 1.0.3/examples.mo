  ...
  package Kundur126 "Example 12.6 from Kundur's book" 
    ...
    class system 
      ...
      ObjectStab.Network.Bus Bus2 annotation (extent=[-96, 118; -76, 138], 
          rotation=90);
      ObjectStab.Network.FixTransformer T26(X=.15/9) annotation (extent=[-96, 
      ...
      ObjectStab.Network.FixTransformer T410(X=.15/9) annotation (extent=[84, 
...
"));
  ...
  package Nordic32 "Nordic 32 test system" 
    ...
    package Models 
      ...
      public 
        Modelica.Blocks.Interfaces.InPort inPort1(final n=1) annotation (extent
            =[-140, 60; -100, 100]);
        Modelica.Blocks.Interfaces.InPort inPort2(n=1) annotation (extent=[-140
              , 10; -100, 50]);
        Modelica.Blocks.Interfaces.InPort inPort3(final n=1) annotation (extent
            =[-140, -50; -100, -10]);
        Modelica.Blocks.Interfaces.InPort inPort4(final n=1) annotation (extent
            =[-140, -100; -100, -60]);
        Modelica.Blocks.Interfaces.OutPort outPort(final n=1) annotation (
      ...
      protected 
        ...
        Real u3=inPort3.signal[1] "Input signal 3";
        Real u4=inPort4.signal[1] "Input signal 4";
      ...
      public 
        ModelicaAdditions.PetriNets.Transition Tr1f annotation (extent=[-60, 12
              ; -40, 32], rotation=270);
        ModelicaAdditions.PetriNets.Place12 countf annotation (extent=[-60, -20
              ; -40, 0], rotation=270);
        ModelicaAdditions.PetriNets.Transition Tr2f annotation (extent=[-80, -
        ...
        ModelicaAdditions.PetriNets.Place11 activatef annotation (extent=[-80, 
              -80; -60, -60], rotation=270);
        ModelicaAdditions.PetriNets.Transition Tr3f annotation (extent=[-100, -
              20; -80, 0], rotation=90);
        ModelicaAdditions.PetriNets.Transition Tr4f annotation (extent=[-20, -
              20; 0, 0], rotation=90);
        ModelicaAdditions.PetriNets.Transition Tr1s annotation (extent=[44, 12
              ; 64, 32], rotation=270);
        ModelicaAdditions.PetriNets.Place12 counts annotation (extent=[44, -20
              ; 64, 0], rotation=270);
        ModelicaAdditions.PetriNets.Transition Tr2s annotation (extent=[24, -50
              ; 44, -30], rotation=270);
        ModelicaAdditions.PetriNets.Place21 waits(initialState=true) 
          annotation (extent=[44, 40; 64, 60], rotation=270);
        ModelicaAdditions.PetriNets.Place11 activates annotation (extent=[24, -
              80; 44, -60], rotation=270);
        ModelicaAdditions.PetriNets.Transition Tr3s annotation (extent=[4, -20
              ; 24, 0], rotation=90);
        ModelicaAdditions.PetriNets.Transition Tr4s annotation (extent=[84, -20
              ; 104, 0], rotation=90);
      equation 
      ...
      model SweGov 
        ...
        Modelica.Blocks.Math.Feedback Feedback1 annotation (extent=[-50, 60; -
              30, 80]);
        Modelica.Blocks.Math.Gain Gain2(k={Rstat}) annotation (extent=[-50, 30
              ; -30, 50], rotation=90);
        Modelica.Blocks.Continuous.Integrator Int(k={1/Tr}) annotation (extent=
              [20, 60; 40, 80]);
        Modelica.Blocks.Math.Add Add3(k1=+1/Rdyn, k2=+1/Rdyn) annotation (
            extent=[60, 60; 80, 80]);
        Modelica.Blocks.Nonlinear.Limiter Limiter1(uMax={GateMax}, uMin={
              GateMin}) annotation (extent=[-6, -10; 14, 10]);
        ...
        Modelica.Blocks.Math.Add AddPm0 annotation (extent=[-34, -10; -14, 10])
          ;
      equation 
        connect(Int.inPort, Filter.outPort) annotation (points=[18, 70; 1, 70])
          ;
        connect(Int.outPort, Add3.inPort2) annotation (points=[41, 70; 58, 64])
          ;
        connect(Feedback1.inPort2, Gain2.outPort) annotation (points=[-40, 62; 
              -40, 52; -40, 51]);
        connect(Add3.inPort1, Filter.outPort) annotation (points=[58, 76; 50, 
              76; 50, 92; 8, 92; 8, 70; 1, 70]);
        connect(Gain2.inPort, Add3.outPort) annotation (points=[-40, 28; -40, 
              22; 90, 22; 90, 70; 84, 70; 81, 70]);
        connect(Water.inPort, Servo.outPort) annotation (points=[48, 0; 43, 0])
          ;
        connect(Servo.inPort, Limiter1.outPort) annotation (points=[18, 0; 15, 
              0]);
        connect(Feedback1.outPort, Filter.inPort) annotation (points=[-31, 70; 
              -24, 70]);
        connect(AddPm0.outPort, Limiter1.inPort) annotation (points=[-13, 0; -8
              , 0], style(color=3));
        connect(werror.outPort, Feedback1.inPort1) annotation (points=[-58, 0; 
              -54, 0; -54, 70; -50, 70], style(color=3));
        connect(Water.outPort, Limiter.inPort) annotation (points=[71, 0; 72, 0
              ], style(color=3));
        connect(AddPm0.inPort1, Gain2.inPort) annotation (points=[-36, 6; -40, 
              6; -40, 26], style(color=3));
      ...
      model SweExc 
        ...
        Modelica.Blocks.Nonlinear.Limiter PSSLim(uMax={.05}, uMin={-.05}) 
          annotation (extent=[10, -70; 30, -50]);
        Modelica.Blocks.Math.Add PSSAdd(k1=+1, k2=+1) annotation (extent=[-20, 
              -10; 0, 10]);
        Modelica.Blocks.Interfaces.InPort inPort5(final n=1) annotation (extent
            =[-138, -80; -98, -40]);
        Modelica.Blocks.Math.Gain G(k={Kpss*ObjectStab.Base.Sbase/Sbase}) 
          annotation (extent=[-26, -70; -6, -50]);
      equation 
        connect(PSStf1.outPort, PSStf.inPort) annotation (points=[-69, -60; -62
              , -60]);
        connect(PSSAdd.outPort, AVRtf.inPort) annotation (points=[1, 0; 24, 0])
          ;
        connect(G.inPort, PSStf.outPort) annotation (points=[-28, -60; -40, -60
              ], style(color=3));
        connect(AVRtf.outPort, Limiter.inPort) annotation (points=[47, 0; 72, 0
              ], style(color=3));
        connect(PSSAdd.inPort2, PSSLim.outPort) annotation (points=[-24, -6; -
              38, -6; -38, -32; 42, -32; 42, -60; 31, -60], style(color=3));
        connect(G.outPort, PSSLim.inPort) annotation (points=[-4, -60; 8, -60]
            , style(color=3));
        connect(Verror.outPort, PSSAdd.inPort1) annotation (points=[-60, 0; -41
              , 0; -41, 6; -22, 6], style(color=3));
        connect(inPort5, PSStf1.inPort) annotation (points=[-128, -60; -92, -60
              ], style(color=3));
      ...
      equation 
        connect(PSStf1.outPort, PSStf.inPort) annotation (points=[-49, -60; -38
              , -60]);
        connect(G.inPort, PSStf.outPort) annotation (points=[-2, -60; -13, -60]
          );
        connect(G.outPort, PSSLim.inPort) annotation (points=[21, -60; 32, -60]
          );
        connect(PSSAdd.inPort2, PSSLim.outPort) annotation (points=[-46, -12; -
              52, -12; -52, -40; 66, -40; 66, -60; 56, -60], style(color=3));
        connect(ExcLimit.inPort3, PSSAdd.outPort) annotation (points=[-4, -3; -
              12, -3; -12, -6; -22, -6], style(color=3));
        connect(ExcLimit.inPort2, inPort3) annotation (points=[-4, 3; -12, 3; -
              12, 90; -111, 90], style(color=3));
        connect(ExcLimit.outPort, AVRtf.inPort) annotation (points=[21, 0; 26, 
              0], style(color=3));
        connect(AVRtf.outPort, Limiter.inPort) annotation (points=[51, 0; 70, 0
              ], style(color=3));
        connect(Limiter.outPort, ExcLimit.inPort1) annotation (points=[95, 0; 
              100, 0; 100, 72; -9, 72; -9, 8; -4, 8], style(color=3));
        connect(PSStf1.inPort, inPort5) annotation (points=[-72, -60; -110, -60
              ], style(color=3));
        connect(ExcLimit.inPort4, inPort4) annotation (points=[-2, -8; -18, -8
              ; -18, 30; -100, 30], style(color=3));
        connect(Verror.outPort, PSSAdd.inPort1) annotation (points=[-58, 0; -48
              , 0], style(color=3));
